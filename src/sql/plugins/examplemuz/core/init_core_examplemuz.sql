...
('PROJECT_MANAGEMENT','examplemuz.adminFeature.ManageProject.name',1,'jsp/admin/plugins/examplemuz/ManageProjects.jsp','examplemuz.adminFeature.ManageProject.description',0,'examplemuz',NULL,NULL,NULL,4);
